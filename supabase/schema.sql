...
revoke all on public.notices, public.knowledge_posts, public.project_rooms, public.project_updates, public.gatherings, public.members, public.site_settings from anon, authenticated;
grant select on public.notices, public.knowledge_posts, public.project_rooms, public.project_updates, public.gatherings, public.members, public.site_settings to anon, authenticated;
grant all on public.notices, public.knowledge_posts, public.project_rooms, public.project_updates, public.gatherings, public.members, public.site_settings to service_role;
...
-- Members may create knowledge posts/project rooms and add project updates; other writes remain admin-only.
